...
class BlazeFacemark(nn.Module):
    ...
    def _define_layers(self):   
        ...
        self.backbone2_2_0 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=0, groups=128, bias=True),
        )
        ...
        self.backbone3_2_0 = nn.Sequential(
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3, stride=1, padding=0, groups=32, bias=True),
        )
    ...
    def predict_on_batch(self, x):
        ...
        out[1] = out[1].clamp(-thresh, thresh).sigmoid()
        return out
